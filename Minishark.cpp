...
int main(){
    int eleccion;
    cout<<"Bienvenido MiniShark"<<endl;
   
    cout<<"Trabajo realizado por Codex"<<endl<<endl;
   
    cout<<"Escoje una opción"<<endl;

    cout<<"[1] Captura paquetes ICMP"<<endl;

    cout<<"[2] Captura paquetes HTTP"<<endl;

    cout<<"[3] Captura paquetes TCP"<<endl;

    cout<<"[4] Captura paquetes DHCP"<<endl;
